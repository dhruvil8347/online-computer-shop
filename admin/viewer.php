				...
				<div class="col" id="<?php echo $product['id']; ?>">
					<div class="card h-100" data-bs-toggle="modal" 
						...
						<div class="card-body">
							...
							<button type="button" class="btn btn-warning"><a href="Update.php?id=<?php echo $product['id']; ?>">Update</a></button>
							<button type="button" class="btn btn-danger"><a href="Delete.php?id=<?php echo $product['id']; ?>">Delete</a></button>
						</div>
					</div>
				</div>
			<?php } }  ?>
